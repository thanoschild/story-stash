...
const { addStory, userAction, getBookmarkAndLike, updateLikeCounts, getStory, updateStory, getStoriesByUserId, getStoriesByCategory } = require("../controllers/storyController");
...
router.get("/get-category", validateToken, getStoriesByCategory);
